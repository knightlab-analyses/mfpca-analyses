# simulate data with 5 modalities based on HMP_T2D
...
##############################
##############################
# 100 subjects, 10 time points, 20% missing, 5 modalities
sim_param = sim_setting_5B(N=100, P=5, N_T_max=10, N_T_mean=8, R_corr=3) 
...
# 	 file=paste0(dir, '/sim_data_5B/', paste(paste('sim_dat_5B', 'N', sim_param$N, 'R_corr', sim_param$R_corr, 'Complete', 
# 	                  sim_param$complete, sep='_'), '.Rdata', sep=''))) # nsim = 100

save(nsims, TIME_SPARSE, Y_SPARSE, MU_SPARSE, F_SPARSE, OMEGA_SPARSE, ALPHA, phi_t, sim_param, 
	 file=paste0(dir, '/sim_data_5B/', paste(paste('sim_dat_5B', 'N', sim_param$N, 'R_corr', sim_param$R_corr, 'Complete', 
	                  sim_param$complete, 'nsims', nsims, sep='_'), '.Rdata', sep=''))) # nsim = 1000
