...
error_nsim = NULL
for (i in 1:nsims){
	tmp = try(load(paste0(dir, '/results_test_cov/R_corr_', dat$sim_param$R_corr, '_test_cov_weakPrior_', i, '.Rdata')), TRUE)
...
save(nsims, cov_true, cov_coverage_95_prob, error_nsim,
	file=paste0('/home/lij014/Oct_2020_mfpca/simulations/results_summary/results_R_corr_', b, '_test_cov_weakPrior.RData'))
