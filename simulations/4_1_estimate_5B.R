...
#load(paste0(dir, "/sim_data_5B/sim_dat_5B_N_100_R_corr_3_Complete_0.8.Rdata"), dat <- new.env())
load(paste0(dir, "/sim_data_5B/sim_dat_5B_N_100_R_corr_3_Complete_0.8_nsims_1000.Rdata"), dat <- new.env())
nsims = dat$nsims
N = dat$sim_param$N
...
save(diff_time, fit, dat_new, Nchains, Nsamples, file=paste0(dir, '/results_est_5B/5D_est_all_nsims', i, '.Rdata'))
