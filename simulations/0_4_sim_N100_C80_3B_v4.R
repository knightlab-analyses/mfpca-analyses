...
print(args)
dir = args[1] # dir = '/panfs/panfs1.ucsd.edu/panscratch/lij014/Oct_2020_mfpca/simulations/sim_data'
...
##############################
##############################
sim_param = sim_setting_3B_T1D(N=100, P=3, N_T_max=10, N_T_mean=8, R_corr=4)
...
save(nsims, TIME_SPARSE, Y_SPARSE, MU_SPARSE, F_SPARSE, OMEGA_SPARSE, ALPHA, phi_t, sim_param, 
	 file=paste0(dir, '/', paste(paste('sim_dat_3B', 'N', sim_param$N, 'R_corr', sim_param$R_corr, 'Complete', 
	                  sim_param$complete, sep='_'), '.Rdata', sep='')))
