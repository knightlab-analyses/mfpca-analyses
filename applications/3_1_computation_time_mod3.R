# calculate computation time for 3 modalities based on 1_4_mfpca_t2d_ALL_model_selection.R 
...
dat_mfpca <- data_mfpca_transformed(df_var=list(microb, metab, protein), 
...
# 2. model selection
#--------------------------
mdl_list <- list(list(num_PCs=c(2,2,2), nknots=c(1,1,1)))
...
save(diff_time, mdl_list, dat_mfpca,
     file=paste0(dir, '/results/mfpca_t2d_compute_time_mod3.RData'))
