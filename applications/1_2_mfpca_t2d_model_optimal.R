...
looic.list = list()
for (i in 1:num_mdl){
    load(paste0(dir, '/results/mfpca_t2d_microb_protein_cytok_mdl_', i, '.RData'))
...
save(looic.list, looic.compare, file=paste0(dir, '/results/mfpca_looic_models_microb_protein_cytok_compare.RData'))
