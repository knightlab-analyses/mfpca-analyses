...
for (i in 1:num_mdl){
    print(paste0('i:', i))
    load(paste0(dir, '/results/mfpca_t2d_microb_protein_cytok_a1c_', i, '.RData'))
...
save(looic.list, looic.compare, file=paste0(dir, '/results/mfpca_looic_models_microb_protein_cytok_a1c_compare.RData'))
