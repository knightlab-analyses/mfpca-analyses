...
load(paste0(dir, "/sim_data/sim_dat_3B_N_100_R_corr_3_Complete_0.8.Rdata"), dat <- new.env())
nsims = dat$nsims
N = dat$sim_param$N
...
save(fit, dat_new, Nchains, Nsamples, file=paste0(dir, '/results_est_all/3D_est_all_R_v3_nsims', i, '.Rdata'))
